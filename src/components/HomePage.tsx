...
export default function HomePage({
 ...
 className="font-serif text-[2rem] sm:text-[2.45rem] leading-[1.08] tracking-tight text-[var(--color-thread-heading)] max-w-[12ch]"
              >
 ...
 <h2 className="font-serif text-[2rem] tracking-tight text-[var(--color-thread-heading)] leading-tight">
